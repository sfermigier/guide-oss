...
Les outils de cette section relèvent d'une logique différente de celle des sections :doc:`/infrastructure/securite` et :doc:`/infrastructure/pki` : il s'agit d'équiper l'utilisateur, sur son poste, contre les risques auxquels il est le premier exposé. Vol ou perte de la machine, réutilisation de mots de passe, interception d'un document en transit : ce sont ses gestes quotidiens qui sont en jeu.
...
:Site: https://www.veracrypt.fr/
:Porteur: une entreprise française (IDRIX)
:Licence: Apache 2.0 et TrueCrypt License 3.0
...
:Porteur: une communauté, avec le soutien du gouvernement allemand
:Licence: GPL v3
...
:Site: https://cryptomator.org/
:Porteur: une entreprise allemande (Skymatic)
:Licence: GPL v3
...
- ClamAV, pour l'analyse antivirale des fichiers (section :doc:`/infrastructure/securite`): https://www.clamav.net
