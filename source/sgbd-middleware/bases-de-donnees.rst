...
:Licence: GPL v2 avec *linking exception*, et propriétaire pour l'édition Enterprise
...
:Porteur: une fondation (MariaDB Foundation) et un éditeur (MariaDB plc)
:Licence: GPL v2
