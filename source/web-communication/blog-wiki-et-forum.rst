...
:Porteur: une communauté (WordPress Foundation) et un éditeur (Automattic)
:Licence: GPL v2+
...
:Porteur: une entreprise (Civilized Discourse Construction Kit, Inc.)
:Licence: GPL v2
