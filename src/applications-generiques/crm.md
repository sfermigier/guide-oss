...
Dans l’univers open source, les solutions les plus actives sont aujourd’hui SuiteCRM, EspoCRM et Odoo. SugarCRM, longtemps la référence du domaine, ne publie plus d’édition communautaire : ce sont ses forks (SuiteCRM, VTiger) qui font vivre son héritage. On trouve également des ERP dont le module de CRM est au meilleur niveau (voir la section [ERP / PGI](erp-pgi.md)).
...
Licence
: Vtiger Public License (dérivée de la MPL)
...
- ERP5 (section [ERP / PGI](erp-pgi.md))
- Odoo (section [ERP / PGI](erp-pgi.md))
...
- Dolibarr, qui intègre un module CRM (section [ERP / PGI](erp-pgi.md))
