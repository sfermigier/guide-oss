...
Porteur
: une entreprise (Metabase)

Licence
: AGPL v3 (édition Open Source) et propriétaire
...
Voir la fiche détaillée dans la section [Décisionnel : Reporting](decisionnel-reporting.md).

## RapidMiner (n'est plus open source) { #rapidminer-n-est-plus-open-source }

Site
: <https://www.siemens.com/en-us/products/rapidminer/>
...
Porteur
: un éditeur (Cloud Software Group)

Licence
: AGPL et propriétaire
...
Porteur
: un éditeur (Hitachi Vantara)

Licence
: LGPL (édition communautaire) et propriétaire
