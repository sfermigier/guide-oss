...
Porteur
: une entreprise autrichienne (LINBIT)
...
- Kubernetes, qui intègre nativement le redémarrage et la redistribution des charges applicatives (section [Virtualisation](virtualisation.md))
