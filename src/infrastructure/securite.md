...
Porteur
: une fondation (OISF - Open Information Security Foundation)
...
- OpenBao, gestion des secrets, fork libre de HashiCorp Vault (section [PKI](pki.md)): <https://openbao.org/>
