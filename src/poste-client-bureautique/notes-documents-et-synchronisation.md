...
Porteur
: une organisation à but non lucratif (Corporation for Digital Scholarship)
...
- Rclone, pour synchroniser avec à peu près n'importe quel stockage distant (section [Sauvegarde](../infrastructure/sauvegarde.md)): <https://rclone.org/>

Les plateformes collaboratives présentées en [GED & ECM](../applications-generiques/ged-ecm.md) fournissent par ailleurs leurs propres clients de synchronisation pour le poste de travail.
