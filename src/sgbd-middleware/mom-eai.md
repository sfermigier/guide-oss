...
Porteur
: un consortium (OW2) et un éditeur (ScalAgent)
...
Porteur
: un éditeur (Broadcom, via VMware Tanzu)
...
- Apache Camel, pour l'intégration et le routage (section [ESB](esb.md)): <https://camel.apache.org/>
