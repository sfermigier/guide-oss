...
Porteur
: un éditeur (MongoDB Inc)

Licence
: SSPL (*Server Side Public License*), non reconnue comme libre par l'OSI
...
Porteur
: un éditeur (Redis Ltd)

Licence
: AGPL v3, RSALv2 ou SSPLv1 au choix, depuis Redis 8 (2025)
...
Porteur
: une entreprise (Hibernating Rhinos Ltd.)
...
Porteur
: une communauté, après le rachat d'OrientDB Ltd par SAP
...
Porteur
: une entreprise (ArangoDB GmbH)

Licence
: BSL 1.1 (*Business Source License*, source-available) depuis la version 3.12
...
Porteur
: une fondation (The Linux Foundation)
