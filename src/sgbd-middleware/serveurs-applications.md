...
Porteur
: un éditeur (Red Hat) et une communauté
...
- Quarkus, pour les architectures conteneurisées (section [Frameworks Web (backend)](../developpement/frameworks-web-backend.md)): <https://quarkus.io/>
