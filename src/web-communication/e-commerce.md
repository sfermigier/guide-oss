...
Licence
: OSL v3 (Magento Open Source) et propriétaire (Adobe Commerce)
...
Porteur
: un éditeur français (PrestaShop SA, groupe MBE Worldwide)

Licence
: AFL v3 pour le cœur, OSL v3 pour les modules
...
- ERP5, Odoo et Dolibarr (section [ERP / PGI](../applications-generiques/erp-pgi.md))
- Apache OFBiz, dont la vocation initiale est le e-commerce (section [ERP / PGI](../applications-generiques/erp-pgi.md))
