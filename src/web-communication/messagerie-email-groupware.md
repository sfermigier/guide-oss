...
Dans cette rubrique, on présente les serveurs de messagerie (SMTP et IMAP), les outils antispam et les interfaces de consultation (groupware). Les antivirus tels que ClamAV sont rangés dans la catégorie [Sécurité](../infrastructure/securite.md), et la messagerie instantanée fait l'objet de la section [Messagerie instantanée et visioconférence](messagerie-instantanee-et-visio.md).
...
Licence
: Eclipse Public License 2.0 et IBM Public License 1.0
...
Porteur
: un éditeur (Zimbra, Inc.)

Licence
: Zimbra Public License, dérivée de la MPL, et propriétaire
...
Porteur
: un éditeur (grommunio GmbH)

Licence
: AGPL v3 et propriétaire
...
Site
: <https://www.openemm.org/>

Porteur
: un éditeur (AGNITAS AG)
