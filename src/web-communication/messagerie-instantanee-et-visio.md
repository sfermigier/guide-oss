...
Site
: <https://matrix.org/> et <https://element.io/>

Porteur
: une fondation (The Matrix.org Foundation) et un éditeur (Element)

Licence
: Apache 2.0 pour la spécification, AGPL v3 pour Synapse et pour les clients Element
...
Porteur
: un éditeur (Mattermost, Inc.)

Licence
: AGPL v3 pour le code source, à l’exception des modules « enterprise » sous licence propriétaire ; binaires officiels sous MIT
...
Porteur
: un éditeur (Rocket.Chat Technologies)

Licence
: MIT, à l’exception des répertoires de l’édition entreprise
...
Porteur
: une entreprise canadienne (Blindside Networks) et une communauté
...
Porteur
: une administration (DINUM, La Suite numérique)
...
Porteur
: une communauté (projet initié par Juliusz Chroboczek)
...
Voir également les sections [VOIP / Téléphonie](voip-telephonie.md) pour la téléphonie sur IP, [Messagerie, Emailing & Groupware](messagerie-email-groupware.md) pour la messagerie électronique et le travail collaboratif, et [Réseaux sociaux d’entreprise (RSE)](reseaux-sociaux-entreprise-rse.md) pour les plateformes sociales d’entreprise.
