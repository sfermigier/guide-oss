...
Porteur
: une communauté, soutenue par la société SignalWire
...
Licence
: Kannel Software License (fondée sur la licence Apache).
...
Pour la visioconférence et la messagerie instantanée, qui relèvent désormais du même besoin métier, voir la section [Messagerie instantanée et visioconférence](messagerie-instantanee-et-visio.md).
